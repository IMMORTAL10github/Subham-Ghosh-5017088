...
import com.dto.EmployeeNameAndEmailDto;
import com.entity.Employee;
import com.projection.EmployeeNameAndEmailProjection;
...
public interface EmployeeRepository extends JpaRepository<Employee, Long> {
    ...
    @Query("SELECT new com.dto.EmployeeNameAndEmailDto(e.name, e.email) " +
